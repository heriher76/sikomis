            ...
            <div class="card">
                ...
                <div class="body">
                    <!-- <form action="{{ url('user/survey-points') }}" id="myForm" class="willSubmit" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <input type="text" name="like" class="form-control" form="willSubmit">
                            </div>
                        </div>
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <input type="text" name="dislike" class="form-control" form="willSubmit">
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                          		<form action="{{ url('admin/activities') }}" id="willSubmit" method="POST">
                          			{{ csrf_field() }}
