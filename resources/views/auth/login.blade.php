        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel" style="padding: 2vw 7vw; margin-top: 5vw;">
          ...
          <div class="carousel-inner" style="border-radius: 10%; min-height: 40vh; max-height: 40vh;">
            <div class="item active">
              <img src="{{ url('slider/' . $infoweb->slider1) }}" alt="Slider Pertama" style="height: 40vh; width: 100%; object-fit: cover;">
            </div>

            <div class="item">
              <img src="{{ url('slider/' . $infoweb->slider2) }}" alt="Slider Kedua" style="height: 40vh; width: 100%; object-fit: cover;">
            </div>

            <div class="item">
              <img src="{{ url('slider/' . $infoweb->slider3) }}" alt="Slider Ketiga" style="height: 40vh; width: 100%; object-fit: cover;">
            </div>
          </div>
