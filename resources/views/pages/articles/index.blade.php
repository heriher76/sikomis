  ...
  <div class="aside-body">
    <article class="article-fw">
      <div class="inner">
        ...
        <div class="details">
          <h1><a href="{{ url('/testing') }}">Lorem Ipsum Dolor Sit Amet Consectetur Adipisicing Elit</a></h1>
          <p>
    ...
    <article class="article-mini">
      ...
      <div class="padding">
        <h1><a href="{{ url('/testing') }}">Duis aute irure dolor in reprehenderit in voluptate velit</a></h1>
        <div class="detail">
          <div class="category"><a href="category.html">Lifestyle</a></div>
    ...
    <article class="article-mini">
      <div class="inner">
        ...
        <div class="padding">
          <h1><a href="{{ url('/testing') }}">Fusce ullamcorper elit at felis cursus suscipit</a></h1>
          <div class="detail">
  ...
  <article class="col-md-12 article-list">
    <div class="inner">
      ...
      <div class="details">
        ...
        <h1><a href="{{ url('/testing') }}">Lorem Ipsum Dolor Sit Consectetur Adipisicing Elit</a></h1>
        <p>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
        ...
        <footer>
          ...
          <a class="btn btn-primary more" href="{{ url('/testing') }}">
            <div>More</div>
